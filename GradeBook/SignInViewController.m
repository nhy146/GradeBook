...
@synthesize unameTextField, passwTextField, studentteachercontrol, signinButton, rows,teacher, student, dictTwo;
    ...
    if(studentteachercontrol.selectedSegmentIndex == 1){//Teacher selected, if query to find in student is empty //where to check if uname and passw are correct?
        ...
        //////////
            ...
            if([rows count] == 0){
                ...
                dictTwo = [rows objectAtIndex: 0]; //why do we do this?
